...
export class TenantError extends EliteError {
  readonly code = "tenant_error";
}
export class RateLimitError extends EliteError {
  readonly code = "rate_limit_error";
  constructor(public retryAfter: number, message: string, requestId?: string) {
    super(message, requestId);
  }
}
export class ValidationError extends EliteError {
  readonly code = "validation_error";
  constructor(public field: string, message: string, requestId?: string) {
    super(message, requestId);
  }
}
