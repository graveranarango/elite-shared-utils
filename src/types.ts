...
export interface ConversationLia {
  id: string;
  tenant_id: string;
...
export interface ConversationSofia {
  id: string;
  tenant_id: string;
  customer_id: string | null;
  channel: string | null;
